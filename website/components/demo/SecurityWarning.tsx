export function SecurityWarning() {
    return (
        ...
        >
            <p style={{ color: "#fecaca", fontWeight: 700 }}>Bu demo gerçek kimlik bilgileriyle çalışabilir.</p>
            <p style={{ color: "#fca5a5", marginTop: "0.45rem" }}>
                Kimlik bilgileriniz GİB’e ulaşmak için sunucu üzerinden geçici bir vekil (proxy) ile iletilir. Bu
                veriler kaydedilmez, günlüklenmez ve kalıcı olarak saklanmaz.
            </p>
            <a
