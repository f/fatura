...
export function UserProfile({ token, loading, userData, onFetch, onSave, onChange }: UserProfileProps) {
    if (token === null) {
        return (
                    ...
                    >
                        <label>
                            ...
                            <input
                                ...
                                onChange={(event) => onChange({ ...userData, taxIDOrTRID: event.target.value })}
                            />
                        </label>
                        <label>
                            <div className="text-muted" style={{ marginBottom: "0.3rem" }}>
