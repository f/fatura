...
export const mdxComponents: MDXComponents = {
  h1: (props) => <h1 className="section-title" style={{ fontSize: "clamp(1.6rem, 4.2vw, 2.6rem)", marginTop: "0.3rem" }} {...props} />,
  ...
  ul: (props) => <ul style={{ marginTop: "0.5rem", paddingLeft: "1rem", display: "grid", gap: "0.35rem" }} {...props} />,
  ol: (props) => <ol style={{ marginTop: "0.5rem", paddingLeft: "1rem", display: "grid", gap: "0.35rem" }} {...props} />,
