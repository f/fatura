    ...
    <div style={{ display: "grid", gap: "1rem" }}>
      ...
      >
        ...
        <p style={{ color: "#fca5a5", marginTop: "0.4rem" }}>
          Bu kütüphane ile imzalanan faturalar resmî mali kayıt oluşturur. Canlı (üretim)
          hesabında işlem yapmadan önce TEST ortamında akışı doğrulayın.
        </p>
      </section>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", minWidth: "680px" }}>
            <thead>
              <tr style={{ textAlign: "left", color: "var(--muted)" }}>
                ...
                <th style={{ padding: "0.7rem", borderBottom: "1px solid var(--line)" }}>Geliştirici</th>
              </tr>
            </thead>
            <tbody>
              {alternatives.map((alt) => (
                <tr key={`${alt.language}-${alt.repo}`}>
                  ...
                  <td style={{ padding: "0.7rem", borderBottom: "1px solid rgba(42,52,65,0.4)" }}>
                    <a href={alt.repo} target="_blank" rel="noreferrer" style={{ color: "var(--accent-soft)" }}>
                      {alt.repo}
                    </a>
                  </td>
                  <td style={{ padding: "0.7rem", borderBottom: "1px solid rgba(42,52,65,0.4)" }}>
